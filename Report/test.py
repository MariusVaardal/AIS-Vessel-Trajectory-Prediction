...
train = pd.concat([train3, train4, train5, train6, train7, train8, train9, train10, train11, train12], ignore_index=True)
...
# Train the model
model_lat = RandomForestRegressor(n_estimators=15, verbose=3, random_state=42, warm_start=False, criterion='absolute_error')
model_lat.fit(X_lat_train.values, y_lat_train.values)

model_lon = RandomForestRegressor(n_estimators=15, verbose=3, random_state=42, warm_start=False, criterion='absolute_error')
